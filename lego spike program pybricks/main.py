...
# giro(50, 180)
golpear_pared(-60, 1, 0)


# subir_barrera(90)
avance_adelante(80, 680, 0)
giro_un_motor(40, 90, 1, 0)
avance_adelante(70, 700, 90)
giro(60, 180)
avance_adelante(40, 130, 180)

subir_barrera(140)
avance_reversa(20, 70, 180)
giro_un_motor(30, 270, 0, 1)
avance_adelante(50, 360, 270)
giro(40, 360)
motor_f.run_time(speed=-1000, time=1000)
giro(40, 450)
avance_adelante(80, 1300, 450)
mostarAngulo()
exit()
motor_f.run_time(speed=-1000, time=1000)
avance_reversa(40, 180, 300)
giro(40, 90)
...
avance_adelante(50, 200, 90)
motor_f.run_time(speed=-1000, time=1000)
golpear_pared(70, 1, 90)
avance_reversa(50, 150, 0)
subir_barrera(120)
motor_f.run_until_stalled(600, then=Stop.HOLD, duty_limit=40)
giro(60, 90)
golpear_pared(-70, 0.6, 90)
